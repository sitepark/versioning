...
public class VersionTypesTest {
	...
	public void testNone() {
		Assertions.assertEquals(
				0,
				VersionTypes.NONE.getTypes().size(),
				"VersionTypes.NONE sollte keine Types beeinhalten");
	}
	...
	public void testDevelopReleasesAndSnapshots() {
		...
		Assertions.assertEquals(
				...
				VersionTypes.DEVELOP_RELEASES_AND_SNAPSHOTS
					.getPublicationStatusTypes(),
				"DEVELOP_RELEASES_AND_SNAPSHOTS sollte die PublicationStatusTypes SNAPSHOTS und RELEASES beeinhalten");
	}
