...
public class DatedBaseVersionTest {
	...
	private static final SnapshotVersion VERSION = new VersionBuilder()
		.setMajor(2)
		.setMinor(4)
		.setIncremental(3)
		.buildSnapshot();
	...
	public void testCompareToEquals() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion equal = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE.plusDays(1).minusDays(1));
	...
	public void testCompareToLater() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion later = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE.plusMinutes(13));
	...
	public void testCompareToEarlier() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion earlier = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE.minusDays(2));
	...
	public void testCompareToLager() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion larger = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION.toRelease(),
				DatedBaseVersionTest.DATE);
	...
	public void testCompareToSmaller() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion smaller = new DatedBaseVersion(
				new VersionBuilder()
	...
	public void testEqualsSameVersion() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion sameVersion = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE.plusDays(1).minusDays(1));
	...
	public void testEqualsSameDate() {
		final DatedBaseVersion version = new DatedBaseVersion(
				DatedBaseVersionTest.VERSION,
				DatedBaseVersionTest.DATE);
		final DatedBaseVersion sameDate = new DatedBaseVersion(
				new VersionBuilder()
					.setMajor(version.getMajor())
					.setMinor(version.getMinor())
	...
	public void testToString() {
		final DatedBaseVersion version = new DatedBaseVersion(
				...
				DatedBaseVersionTest.DATE);
		Assertions.assertEquals(
				DatedBaseVersionTest.VERSION.toString()
					+ "<2021-04-15T13:04:46.190721000>",
				version.toString());
	}
}
