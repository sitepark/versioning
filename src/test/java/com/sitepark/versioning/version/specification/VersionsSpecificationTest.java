...
public class VersionsSpecificationTest {
  ...
  public void testEmptySpecification() {
    Assertions.assertThrows(IllegalArgumentException.class, () -> this.builder().build());
  }
  ...
  public void testSingleVersionRangeInclusiveUpperContains() {
    ...
    Assertions.assertTrue(specification.containsVersion(this.onePointTwoSnapshot));
    Assertions.assertFalse(specification.containsVersion(this.onePointTwoPointOne));
  }
  ...
  public void testSingleVersionRangeInclusiveLowerContains() {
    ...
    Assertions.assertTrue(specification.containsVersion(this.onePointTwo));
    Assertions.assertFalse(specification.containsVersion(this.onePointTwoBranch));
    Assertions.assertFalse(specification.containsVersion(this.onePointTwoSnapshot));
    Assertions.assertTrue(specification.containsVersion(this.onePointTwoPointOne));
  }
  ...
  public void testVersionRangesPartialIntersection() {
    final InclusiveLowerBoundary highestLower =
        new InclusiveLowerBoundary(this.onePointTwoSnapshot);
  ...
  public void testMultipleVersionRangesIntersection() {
    final InclusiveLowerBoundary lower1 = new InclusiveLowerBoundary(this.onePointTwoSnapshot);
    final ExclusiveUpperBoundary upper1 = new ExclusiveUpperBoundary(this.onePointTwo);
    final ExclusiveLowerBoundary lower2 = new ExclusiveLowerBoundary(this.onePointTwo);
  ...
  public void testMultipleVersionRangesOfDifferentBranchesIntersection() {
    final ExclusiveLowerBoundary lower = new ExclusiveLowerBoundary(this.onePointTwo);
    final InclusiveUpperBoundary upper = new InclusiveUpperBoundary(this.onePointTwoPointOne);
    final VersionsSpecification specification1 =
        this.builder()
            .addVersionRange(
                new VersionRangeElement(
