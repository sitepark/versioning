...
public class VersionsSpecificationParserTest {
  ...
  private static final VersionsSpecificationParser PARSER = new VersionsSpecificationParser();
  ...
  @Test
  public void testSingleCompletelyUnlimitedVersionRange() throws ParseException {
  ...
  @Test
  public void testMultipleLowerUnlimitedVersionRanges() throws ParseException {
    Assertions.assertEquals(
        new VersionsSpecificationBuilder()
            .addVersionRange(
                new UnlimitedLowerBoundary(),
  ...
  @Test
  public void testMultipleLowerUnlimitedVersionRangesOfTheSameBranch() throws ParseException {
    Assertions.assertThrows(
        ElementsIntersectException.class,
        () -> VersionsSpecificationParserTest.PARSER.parse("(,1.0-feature], (,2.0-feature)"));
  }
}
