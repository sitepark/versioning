...
public class VersionTest {
  ...
  public void testSnapshotCompareTo() throws ParseException {
    final Version smaller =
        VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch-SNAPSHOT").get();
    final Version bigger = VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch").get();
    Assertions.assertTrue(smaller.compareTo(bigger) < 0);
    Assertions.assertTrue(bigger.compareTo(smaller) > 0);
    Assertions.assertTrue(smaller.compareTo(smaller) == 0);
    Assertions.assertTrue(bigger.compareTo(bigger) == 0);
  ...
  public void testQualifierValueCompareTo() throws ParseException {
    final Version smaller =
        VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch-alpha-SNAPSHOT").get();
    final Version bigger =
        VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch-beta-SNAPSHOT").get();
    Assertions.assertTrue(smaller.compareTo(bigger) < 0);
    Assertions.assertTrue(bigger.compareTo(smaller) > 0);
    Assertions.assertTrue(smaller.compareTo(smaller) == 0);
  }
  ...
  public void testQualifierAmountCompareTo() throws ParseException {
    final Version smaller =
        VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch-alpha-beta-SNAPSHOT").get();
    final Version bigger =
        VersionTest.PARSER.parsePotentialSnapshot("1.1.1-branch-alpha-SNAPSHOT").get();
    Assertions.assertTrue(smaller.compareTo(bigger) < 0);
    Assertions.assertTrue(bigger.compareTo(smaller) > 0);
  ...
  public void testConcreteSnapshotTimestampCompareTo() throws ParseException {
    final Version smaller =
        VersionTest.PARSER
            .parsePotentialConcreteSnapshot("1.1.1-branch-alpha-20210101.101010-13")
            .get();
    final Version bigger =
        VersionTest.PARSER
            .parsePotentialConcreteSnapshot("1.1.1-branch-alpha-20210101.101027-13")
            .get();
    Assertions.assertTrue(smaller.compareTo(bigger) < 0);
    Assertions.assertTrue(bigger.compareTo(smaller) > 0);
    Assertions.assertTrue(smaller.compareTo(smaller) == 0);
  ...
  public void testConcreteSnapshotBuildnumberCompareTo() throws ParseException {
    ...
    final Version bigger =
        VersionTest.PARSER
            .parsePotentialConcreteSnapshot("1.1.1-branch-alpha-20210101.101027-16")
            .get();
    Assertions.assertTrue(smaller.compareTo(bigger) < 0);
    Assertions.assertTrue(bigger.compareTo(smaller) > 0);
    Assertions.assertTrue(smaller.compareTo(smaller) == 0);
