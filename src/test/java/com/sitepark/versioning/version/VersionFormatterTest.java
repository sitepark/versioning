...
public class VersionFormatterTest {
  ...
  public void testRawStringFormat() {
    ...
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.featureVersion));
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.fullVersion));
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.qualifiersVersion));
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(format, formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testLiteralColonFormat() {
    ...
    final VersionFormatter formatter = new VersionFormatter(format);
    Assertions.assertEquals(expected, formatter.format(VersionFormatterTest.featureVersion));
    Assertions.assertEquals(expected, formatter.format(VersionFormatterTest.fullVersion));
    Assertions.assertEquals(expected, formatter.format(VersionFormatterTest.qualifiersVersion));
    Assertions.assertEquals(expected, formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(expected, formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(
        expected, formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testFeatureKeyword() {
    ...
    final VersionFormatter formatter = new VersionFormatter(format);
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.featureVersion));
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.fullVersion));
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.qualifiersVersion));
    Assertions.assertEquals(absent, formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(absent, formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(
        snapshot, formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testSnapshotKeyword() {
    ...
    final VersionFormatter formatter = new VersionFormatter(format);
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.featureVersion));
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.fullVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.qualifiersVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testQualifiersKeyword() {
    ...
    Assertions.assertEquals(present, formatter.format(VersionFormatterTest.qualifiersVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(empty, formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testAllKeywords() {
    final String format =
        "|:MAJOR:|:MINOR:|:INCREMENTAL:|:FEATURE:"
            + "|:SNAPSHOT:|:TIMESTAMP:|:BUILDNUMBER:|:QUALIFIERS:|";
    final VersionFormatter formatter = new VersionFormatter(format);
    Assertions.assertEquals(
        "|1|2|3|my_feature|||||", formatter.format(VersionFormatterTest.featureVersion));
    Assertions.assertEquals(
        "|1|2|3|my_feature|SNAPSHOT|" + "20121209.171545|13|some-other-qualifiers|",
    ...
    Assertions.assertEquals("|1|2|3||||||", formatter.format(VersionFormatterTest.simpleVersion));
    Assertions.assertEquals(
        "|1|2|3||SNAPSHOT|20121209.171545|13||",
        formatter.format(VersionFormatterTest.snapshotVersion));
    Assertions.assertEquals(
        "|1|2|3|SNAPSHOT|||||", formatter.format(VersionFormatterTest.unparsedSnapshotVersion));
  }
  ...
  public void testKeywordPrefix() {
    ...
    final VersionFormatter formatter = new VersionFormatter(format);
    Assertions.assertEquals("-present-1-", formatter.format(VersionFormatterTest.simpleVersion));
  }

  @Test
  public void testUnknownKeyword() {
    final String format = "the qualifiers are :NOTAKEYWORD:.";
    Assertions.assertThrows(IllegalFormatFlagsException.class, () -> new VersionFormatter(format));
  }
