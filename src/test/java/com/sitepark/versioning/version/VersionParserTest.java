...
public class VersionParserTest {
  ...
  public void testFullRelease() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifierB");
  ...
  public void testReleaseWithoutBranch() throws ParseException {
    final ReleaseVersion version = VersionParserTest.PARSER.parseRelease("1.2.3");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
    Assertions.assertEquals(3, version.getIncremental());
  ...
  public void testFullDevelopRelease() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1.2.3-develop-qualifierA-qualifierB");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
    Assertions.assertEquals(3, version.getIncremental());
    Assertions.assertEquals(Branch.DEVELOP, version.getBranch());
  ...
  public void testReleaseWithoutIncremental() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1.2-branch-qualifierA-qualifierB");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
  ...
  public void testReleaseWithoutMinor() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1..3-branch-qualifierA-qualifierB");
    Assertions.assertEquals(1, version.getMajor());
  ...
  public void testReleaseWithoutMinorAndIncremental() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1-branch-qualifierA-qualifierB");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(0, version.getMinor());
    Assertions.assertEquals(0, version.getIncremental());
    Assertions.assertEquals(new Branch("branch"), version.getBranch());
  ...
  public void testReleaseWithoutMajor() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease(".2.3-branch-qualifierA-qualifierB");
  ...
  public void testReleaseWithoutMajorAndIncremental() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease(".2.-branch-qualifierA-qualifierB");
    Assertions.assertEquals(0, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
    Assertions.assertEquals(0, version.getIncremental());
    Assertions.assertEquals(new Branch("branch"), version.getBranch());
  ...
  @Test
  public void testReleaseWithoutMajorAndMinorAndIncremental() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("..-branch-qualifierA-qualifierB");
    Assertions.assertEquals(0, version.getMajor());
    Assertions.assertEquals(0, version.getMinor());
    Assertions.assertEquals(0, version.getIncremental());
    Assertions.assertEquals(new Branch("branch"), version.getBranch());
  ...
  @Test
  public void testReleaseWithTimestampBuildnumberLikeQualifiers() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1.2.3-20210101.131313-123");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
    Assertions.assertEquals(3, version.getIncremental());
    Assertions.assertEquals(new Branch("20210101.131313"), version.getBranch());
  ...
  public void testReleaseWithSnapshotLikeQualifier() throws ParseException {
    final ReleaseVersion version =
        VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifierB-SNAPSHOT");
    Assertions.assertEquals(1, version.getMajor());
    Assertions.assertEquals(2, version.getMinor());
    Assertions.assertEquals(3, version.getIncremental());
    Assertions.assertEquals(new Branch("branch"), version.getBranch());
  ...
  @Test
  public void testReleaseVersionWithNonNumericalMajor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("a.2.3-branch-qualifierA-qualifierB"));
  }

  @Test
  public void testReleaseVersionWithNonNumericalMinor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.b.3-branch-qualifierA-qualifierB"));
  }

  @Test
  public void testReleaseVersionWithNonNumericalIncremental() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.2.c-branch-qualifierA-qualifierB"));
  }

  @Test
  public void testReleaseVersionEmptyString() throws ParseException {
    Assertions.assertThrows(ParseException.class, () -> VersionParserTest.PARSER.parseRelease(""));
  }

  @Test
  public void testReleaseVersionTextString() throws ParseException {
    Assertions.assertThrows(
        ParseException.class, () -> VersionParserTest.PARSER.parseRelease("someText"));
  }
  ...
  public void testReleaseVersionWithWhitespace() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifier B"));
  }
  ...
  public void testReleaseVersionWithNewLine() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifier\nB"));
  }
  ...
  public void testReleaseVersionWithReturn() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifier\rB"));
  }
  ...
  public void testReleaseVersionWithBackspace() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () -> VersionParserTest.PARSER.parseRelease("1.2.3-branch-qualifierA-qualifier\bB"));
  }
  ...
  public void testConcreteSnapshotWithTimestampBuildnumberLikeQualifiers() throws ParseException {
    ...
    Assertions.assertEquals(2, snapshot.getMinor());
    Assertions.assertEquals(3, snapshot.getIncremental());
    Assertions.assertEquals(new Branch("20210101.131313"), snapshot.getBranch());
  ...
  public void testSnapshotParsedAsConcreteSnapshot() throws ParseException {
    ...
    Assertions.assertEquals("qualifierA", release.getQualifiers().get(0));
    Assertions.assertEquals("qualifierB", release.getQualifiers().get(1));
    Assertions.assertEquals("SNAPSHOT", release.getQualifiers().get(2));
  }

  @Test
  public void testConcreteSnapshotVersionEndsWithHyphon() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithEmptyQualifier() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithNonNumericalMajor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithNonNumericalMinor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithNonNumericalIncremental() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithWhitespace() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithLiteralTab() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithBackspace() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testConcreteSnapshotVersionWithNullTerminator() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseConcreteVersion(
  ...
  @Test
  public void testSnapshotVersionWithNonNumericalMajor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseBaseVersion(
  ...
  @Test
  public void testSnapshotVersionWithNonNumericalMinor() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseBaseVersion(
  ...
  @Test
  public void testSnapshotVersionWithNonNumericalIncremental() throws ParseException {
    Assertions.assertThrows(
        ParseException.class,
        () ->
            VersionParserTest.PARSER.parseBaseVersion(
