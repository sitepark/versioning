 ...
 */
class PotentialSnapshotParseExecutor
		extends VersionParseExecutor<PotentialSnapshotVersion> {
	...
	protected PotentialSnapshotVersion buildVersion() {
		return this.hasSnapshotQualifier
			? PotentialSnapshotVersion.ofSnapshot(
					this.versionBuilder.buildSnapshot())
			: PotentialSnapshotVersion.ofRelease(
