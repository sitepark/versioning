...
public final class VersionTypes {
	...
	public static final class BranchType extends Type {
		 ...
		 * @see Branch#isDevelop()
		 */
		public static final BranchType DEVELOP
				= new BranchType("develop", 0b0000_0100);
		/**
		 ...
		 * @see Branch#isFeature()
		 */
		public static final BranchType FEATURES
				= new BranchType("features", 0b0000_1000);
	 ...
	 */
	public static final VersionTypes ONLY_DEVELOP_RELEASES = new VersionTypes(
			BranchType.DEVELOP,
			PublicationStatusType.RELEASES);
	/**
	 * Instance that includes exactly {@link BranchType#DEVELOP}
	 ...
	 */
	public static final VersionTypes ONLY_DEVELOP_SNAPSHOTS = new VersionTypes(
			BranchType.DEVELOP,
			PublicationStatusType.SNAPSHOTS);
	/**
	 * Instance that includes exactly {@link BranchType#DEVELOP},
	...
	public boolean equals(final Object other) {
		return other instanceof VersionTypes
			&& this.value == ((VersionTypes)other).value;
	}
	...
	private String joinTypes(final Set<? extends Type> types) {
		...
		final StringBuilder stringBuilder
				= new StringBuilder(iterator.next().toString());
