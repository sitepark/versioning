...
public final class PotentialConcreteSnapshotVersion {
	 ...
	 */
	public static PotentialConcreteSnapshotVersion ofSnapshot(
			final ConcreteSnapshotVersion version) {
	 ...
	 * @see #ofVersion(ConcreteVersion)
	 */
	public static PotentialConcreteSnapshotVersion ofRelease(
	 ...
	 * @see #ofRelease(ReleaseVersion)
	 */
	public static PotentialConcreteSnapshotVersion ofVersion(
			final ConcreteVersion version) {
		if (version instanceof ConcreteSnapshotVersion) {
			return PotentialConcreteSnapshotVersion.ofSnapshot(
					(ConcreteSnapshotVersion)version);
		}
		if (version instanceof ReleaseVersion) {
			return PotentialConcreteSnapshotVersion.ofRelease(
					(ReleaseVersion)version);
		}
		throw new IllegalArgumentException(
				"required either a ConcreteSnapshotVersion or a ReleaseVersion,"
					+ " got " + version.getClass().getName());
	}
	 ...
	 */
	public void ifIsSnapshot(
			final Consumer<? super ConcreteSnapshotVersion> action) {
		if (this.isSnapshot()) {
	 ...
	 * @see #ifIsSnapshotOrElse(Consumer, Consumer)
	 */
	public void ifIsRelease(
			final Consumer<? super ReleaseVersion> action) {
		if (this.isRelease()) {
	 ...
	 * @see #getReleaseOrElse(ReleaseVersion)
	 */
	public ConcreteSnapshotVersion getSnapshotOrElse(
			final ConcreteSnapshotVersion other) {
	...
	public <R> R mapEither(
			final Function<? super ConcreteSnapshotVersion, ? extends R>
					snapshotMapper,
